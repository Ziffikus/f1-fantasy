...
export default function DraftTicker({ picks, draftOrder, isDraftComplete, weekend }) {
  ...
  }, [entries.length, draftOrder, weekend, comments])
  ...
  }, [isDraftComplete, weekend, entries.length, outro])

  useEffect(() => {
    if (listRef.current)
      listRef.current.scrollTop = listRef.current.scrollHeight
  }, [entries.length, outro, comments])
  ...
  return (
    <div className="draft-ticker">
      <div className="draft-ticker-header">
        <span className="draft-ticker-title"><Flag size={13} /> Live Ticker (Gemini Powered)</span>
